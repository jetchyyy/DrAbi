...
interface BillingReceiptPrintDocumentInput {
...
function buildReceiptRows(items: BillingReceiptLineItem[]) {
...
export function buildBillingReceiptPrintDocument(
  input: BillingReceiptPrintDocumentInput,
) {
  return `<!doctype html>
<html lang="en">
  <head>
      ...
      <section class="receipt" aria-label="CPRMed billing receipt">
        ...
        <section class="totals">
          <div class="sale-details">
            <p>Invoice No.: ${escapeHtml(input.invoiceNumber)}</p>
