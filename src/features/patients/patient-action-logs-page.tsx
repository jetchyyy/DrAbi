      ...
      <div className="border border-slate-200 bg-white shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-extrabold uppercase tracking-widest text-orange-600">Patient Activity</p>
                  ...
                  <tr className="transition-colors hover:bg-slate-50" key={log.id}>
                    <td className="px-4 py-3 align-top">
                      <div className="flex items-center gap-2">
                        <div className={`p-1.5 text-white ${log.action === 'edit' ? 'bg-orange-600' : 'bg-rose-600'}`}>
