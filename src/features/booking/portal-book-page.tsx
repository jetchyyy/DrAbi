  ...
  const onSubmit = form.handleSubmit(async (values) => {
    ...
    const receiptCode =
      "receipt_code" in createdBooking
        ? createdBooking.receipt_code
        : createdBooking.receiptCode;
    toast.success(
    ...
    <div className="grid gap-6 xl:grid-cols-[1fr_0.8fr]">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <FormField label="Cashier flow">
              <Input
                disabled
                readOnly
                value="Present receipt QR at cashier before staff processing"
              />
            </FormField>
          </div>
      ...
      <Card>
        ...
        <div className="mt-5 space-y-4 text-sm text-slate-600">
          <p>
            Once booked, the slot is blocked so another patient cannot take the
            same date and time.
          </p>
          <p>
            Your booking receipt will appear in{" "}
            <Link
