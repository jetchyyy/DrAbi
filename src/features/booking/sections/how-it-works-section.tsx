...
function MiniServicePlaceholder() {
  return (
    <div className="rounded-lg border border-sky-100/90 bg-white p-2 shadow-sm">
      <div className="aspect-square rounded-md bg-gradient-to-br from-sky-100 to-sky-200/85" />
      <div className="mt-2 space-y-1">
        <div className="h-1.5 w-4/5 rounded-full bg-sky-200/90" />
        <div className="h-1 w-3/5 rounded-full bg-sky-100" />
      </div>
    </div>
  );
}
          ...
          <div className="mt-14 grid grid-cols-1 gap-14 sm:gap-16 lg:mt-[4.75rem] lg:grid-cols-2 lg:items-center lg:gap-x-16 lg:gap-y-14 xl:mt-[5.25rem] xl:gap-x-20">
            ...
            <ScrollReveal className="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none lg:justify-self-start" yOffset={22}>
              <div className="relative isolate min-h-[min(420px,88vw)] w-full max-w-[min(420px,100%)] sm:min-h-[440px] sm:max-w-[460px] lg:min-h-[460px] lg:max-w-[500px]">
                ...
                <div className="absolute bottom-0 right-0 z-[25] w-[min(292px,calc(100%-0.5rem))] sm:bottom-1 sm:w-[min(304px,calc(100%-1rem))] lg:bottom-2">
                  <div className="isolate">
                    <div className="relative rounded-2xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_28px_56px_-24px_rgba(15,23,42,0.28)] ring-1 ring-slate-900/[0.05] backdrop-blur-sm sm:p-5">
                      <p className="font-sans text-xs font-semibold text-slate-800">Popular services</p>
                    ...
                    <div className="absolute right-5 top-0 z-[100] flex max-w-[calc(100%-1.25rem)] -translate-y-[42%] items-center sm:right-7">
                      <span className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[var(--color-primary)] px-4 py-2.5 font-sans text-sm font-semibold text-white shadow-[0_14px_32px_-14px_color-mix(in_srgb,var(--color-primary)_80%,transparent)] ring-1 ring-black/[0.06]">
                        Start booking
                      </span>
                    </div>
                  </div>
