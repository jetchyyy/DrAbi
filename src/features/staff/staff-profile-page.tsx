...
import {
  updateCurrentStaffProfileLiveOrDemo,
  updateCurrentUserPasswordLiveOrDemo,
...
export function StaffProfilePage() {
  ...
  const profileMutation = useMutation({
    ...
    onSuccess: async () => {
      await queryClient.invalidateQueries({
        queryKey: queryKeys.currentProfile(profile?.id ?? null),
      });
  ...
  const passwordMutation = useMutation({
    mutationFn: async (values: PasswordFormValues) =>
      updateCurrentUserPasswordLiveOrDemo(values.newPassword),
    onSuccess: () => {
      passwordForm.reset();
      ...
      <Card>
        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            <FormField
              hint="Your full name is shown from your account record."
              label="Full name"
            >
              <Input disabled value={profile?.fullName ?? ""} />
            </FormField>
            <FormField
              hint="Email is used as your login."
              label="Email address"
            >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              <Input
                placeholder="e.g. Staff Nurse, Cashier, Resident Doctor"
          ...
          <p className="text-sm text-slate-500">
            Use this page to keep your own account details up to date. Your
            assigned access role is managed by the admin team.
          </p>
        ...
        <Card>
          ...
          <form
            ...
            onSubmit={passwordForm.handleSubmit(async (values) =>
              passwordMutation.mutateAsync(values),
            )}
          >
            <FormField
            ...
            <Button
              className="rounded-none px-6 py-3 font-extrabold uppercase tracking-widest"
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Input
                ...
                maxLength={6}
                onChange={(event) =>
                  handlePinFieldChange("pin", event.target.value)
                }
              ...
              <Input
                ...
                maxLength={6}
                onChange={(event) =>
                  handlePinFieldChange("confirm", event.target.value)
                }
