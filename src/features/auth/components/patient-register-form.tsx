    ...
    <Card className="w-full max-w-2xl p-8">
      ...
      <form className="mt-8 space-y-4" onSubmit={onSubmit}>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <FormField error={form.formState.errors.password?.message} label="Password">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <FormField error={form.formState.errors.emergencyContactName?.message} label="Emergency contact name">
            <Input {...form.register('emergencyContactName')} />
          </FormField>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <FormField error={form.formState.errors.emergencyContactPhone?.message} label="Emergency contact phone">
