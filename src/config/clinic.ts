...
export const defaultClinicSettings: ClinicSettings = {
  ...
  clinicName: 'Medika',
  legalName: 'Medika Services',
  shortCode: 'MEDIKA',
  address:
    '4F JJACCIS Building, Acacia Avenue, Madrigal Business Park, Alabang, Muntinlupa City',
  contactNumber: '+639171070863',
  email: 'assist@medikaservices.com',
  website: 'https://medikaservices.com',
  logoUrl: '',
  primaryColor: '#4cb154',
  accentColor: '#ef282c',
  bookingLeadDays: 30,
